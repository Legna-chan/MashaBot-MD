...
global.dev = 'Legna'
global.textbot = 'http://mundo-otaku.estudiantes.info/2015/05/kaomojis-emoticonos-japoneses-kawaii.html?m=1'
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '❀ mᥲsһᥲ kᥙȷ᥆ᥙ ☄︎︎', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
