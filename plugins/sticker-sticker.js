...
if (!img) return conn.reply(m.chat, `🍡 Por favor, envia una imagen o video para hacer un sticker.`, m, m)
...
else return conn.reply(m.chat, '🍡 Por favor, envia una imagen o video para hacer un sticker.', m, m)
