...
if (!img) return conn.reply(m.chat, `🐻 Responde a una imagen o vídeo para hacer sticker.`, m, rcanal)
...
else return conn.reply(m.chat, '🐻 Responde a una imagen o vídeo para hacer sticker.', m, rcanal)
